...
@section('content')
    <div class="w-100 h-100 d-flex justify-content-center align-items-center">
        <div class="text-center mt-auto mb-auto" style="width:40%">
            ...
            <div class="mr-0 d-flex align-items-center">
                ...
                @method('get')
                @csrf
                <button class="border-0 bg-transparent"title="edit task`qq23
                ">
                ...
                <button class="border-0 bg-transparent" title="delete" type="button" data-target="#exampleModalCenter" data-toggle="modal">
